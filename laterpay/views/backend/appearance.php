...
<div class="lp_page wp-core-ui">
    ...
    <div class="lp_pagewrap">
        ...
        <div class="lp_row lp_clearfix lp_m--b1">
            <h2><?php _e( 'Rating of Purchased Content', 'laterpay' ); ?></h2>
            <img class="lp_uiElementPreview lp--large lp_left lp_m--t05 lp_m--r2" src="<?php echo $config->get( 'image_url' ) . 'content-rating-2x.png'; ?>">
            <div class="lp_m--t2">
        ...
        <div class="lp_row">
            ...
            <code class="lp_codeSnippet lp--shownAbove lp_block">
        ...
        <div class="lp_row">
            ...
            <img class="lp_uiElementPreview lp--large lp_m--t05" src="<?php echo $config->get( 'image_url' ) . 'shortcode-alignment-2x.png'; ?>">
        </div>
        <hr class="lp_m--1-0 lp_m--b3">
